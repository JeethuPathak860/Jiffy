...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { name: "Projects", path: "/projects", icon: faPrint },
    { name: "My Task", path: "/my-task", icon: faCheckCircle },
    { name: "Team Task", path: "/team-task", icon: faUsers },
    { name: "Create Team", path: "/create-team", icon: faUserPlus },
    { name: "Meeting", path: "/meeting", icon: faVideo },
    {
      name: "Employee Tracker",
      path: "/employee-tracker",
      icon: faAddressCard,
    },
    { name: "Issue Tracker", path: "/issue-tracker", icon: faBug },
    { name: "Manage Leave", path: "/leave-mgt", icon: faClock },
    { name: "Team Report", path: "/team-report", icon: faChartBar },
    { name: "Chat", path: "/chat", icon: faComments },
    { name: "Community", path: "/community", icon: faHandshake },
  ];
  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-gray-200 ${scrolling ? 'scrolling' : 'scrollbar-none'}`}
