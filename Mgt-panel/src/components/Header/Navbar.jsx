    ...
    <nav className={`w-full h-16 flex items-center justify-between px-6 transition-all duration-300 
      ...
      <div className="flex items-center space-x-6">
        ...
        <div className="flex items-center space-x-2 cursor-pointer" onClick={() => toggleDropdown("profile")}>
          ...
          <span className="text-blue-900 font-semibold">Hello, Jeethu Pathak</span>
      ...
      <AnimatePresence>
        {dropdownVisible.profile && (
          <motion.div
            ...
            exit={{ opacity: 0, translateY: -10 }}
            transition={{ duration: 0.3 }}
            className="absolute top-16 right-0 bg-white shadow-lg rounded-xl p-4 mt-1 w-64"
          >
            <div className="flex items-center space-x-2 cursor-pointer hover:bg-gray-100 rounded-lg p-2" onClick={handleProfileClick}>
