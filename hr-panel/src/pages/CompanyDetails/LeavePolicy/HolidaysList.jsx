...
const initialHolidaysData = [
  { id: 1, name: "New Year's Day", startDate: "2023-01-01", endDate: "2023-01-01" },
  { id: 2, name: "Christmas", startDate: "2023-12-25", endDate: "2023-12-25" },
  ...
  return (
    <div className="min-h-screen mt-4 flex flex-col bg-gray-50">
      <div className="flex justify-between items-center p-6 bg-white shadow">
        <h1 className="text-2xl font-semibold text-gray-800">Holidays List</h1>
        <button
            ...
            <tbody className="text-gray-700">
              {currentHolidays.map((holiday, index) => (
                <tr key={holiday.id} className="border-t border-gray-300">
                  ...
                  <td className="py-3 px-6">{holiday.startDate}</td>
                  <td className="py-3 px-6">{holiday.endDate}</td>
